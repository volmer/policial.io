...
Devise.setup do |config|
  ...
  # config.secret_key = 'e33c58282b5ca35eca6632d312f54e7b6a47ad73a5ae20c33'
  ...
  # session. If you need permissions, you should implement that in a before filt
  ...
  # config.pepper = 'b821d2be74e5643f70feedfe788eec751eb083f508ca1f301959f54bb'
  ...
  # initial account confirmation) to be applied. Requires unconfirmed_email
  ...
  # :failed_attempts = Locks an account after a number of failed sign in.
  ...
  # When set to false, does not sign a user in automatically after their passwor
  # reset. Defaults to true, so a user is signed in automatically after a reset.
  # config.sign_in_after_reset_password = true

  # ==> Configuration for :encryptable
  # Allow you to use another encryption algorithm besides bcrypt (default).
  # :sha1, :sha512 or encryptors from others authentication tools as :clearance_
  # :authlogic_sha512 (then you should set stretches above to 20 for default beh
